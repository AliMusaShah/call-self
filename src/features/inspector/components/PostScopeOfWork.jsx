...
const PostScopeOfWork = () => {



    const { values } = useFormikContext()
    // console.log(values, 'values in PostScopeOfWork')
    return (
            ...
            {() => (
                <div className=' p-1 '>
                    ...
                    <div className="bg-gray-50 rounded-lg p- space-y-4">
                        {values?.selectedScope?.length > 0 && (
                            values?.selectedScope?.map((sow, index) => (
                                <div key={index} className="flex items-start justify-between gap-6 py-2 border-b border-gray-400">
                                    ...
                                    <div className='flex-shrink-0 mt-0.5'>
                                        <Field
                                            name={`selectedScope.${index}.isChecked`}
                                            type="checkbox"
...
export default PostScopeOfWork